...
export const CHANGING_POSITION = 'SYSTEM/CHANGING-POSITION'
export const POSITION_CHANGED = 'SYSTEM/POSITION-CHANGED'
export const VIRTUAL_INPUT = 'SYSTEM/VIRTUAL-INPUT'
export const VIRTUAL_KEY = 'SYSTEM/VIRTUAL-KEY'
export const DIALOG_SET_START = 'SYSTEM/START-DIALOG-SET'
export const DIALOG_SET_STARTED = 'SYSTEM/DIALOG_SET_STARTED'
export const DIALOG_SET_SET = 'SYSTEM/SET-DIALOG'
export const DIALOG_SET_UPDATED = 'SYSTEM/DIALOG-SET'
export const WRITE_OUTPUT = 'SYSTEM/WRITE-OUTPUT'
